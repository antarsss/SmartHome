...
import com.n8plus.smarthome.View.CameraPage.CameraDetails.ControlCamera;
import com.n8plus.smarthome.View.LightPage.ControlLightView;
import com.n8plus.smarthome.View.DoorPage.DoorList.DoorListView;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> implements ItemTouchHelperAdapter {
    ...
    private void goToDeviceView(Notification notification) {
        switch (notification.getType()) {
            ...
            case LIGHT_ON:
            case LIGHT_OFF: {
                Intent intent = new Intent(context, ControlLightView.class);
                context.startActivity(intent);
                break;
            }
            case CAMERA_CAPTURE:
            case CAMERA_WARNING: {
                Intent intent = new Intent(context, ControlCamera.class);
                context.startActivity(intent);
                break;
            }
        }
