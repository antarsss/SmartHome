package com.n8plus.smarthome.View.CameraPage.CameraDetails;
...
import com.n8plus.smarthome.Presenter.CameraPresenter.ControlCamera.ControlCameraPresenter;
...
public class ControlCamera extends AppCompatActivity implements ControlCameraViewImpl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        screenShot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (screenshot != null) {
                    ...
                    Toast.makeText(ControlCamera.this, "Save failure!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        pushToTalk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ControlCamera.this, "Click push to talk!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        recordVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ControlCamera.this, "Click record video!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void saveImage(Bitmap finalBitmap) {
        ...
        try {
            ...
            fis.close();
            fos.close();
            Toast.makeText(ControlCamera.this, "Save success!", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
