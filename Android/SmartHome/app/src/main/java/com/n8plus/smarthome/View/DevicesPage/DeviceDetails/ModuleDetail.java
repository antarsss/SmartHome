package com.n8plus.smarthome.View.DevicesPage.DeviceDetails;
...
import com.n8plus.smarthome.Presenter.DevicesPresenter.DeviceDetails.ConnectModulePresenter;
            ...
            lsvModuleDoor.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (arrayList.get(position).isConnect()) {
                        ...
                        switch (arrayList.get(position).getModuleType()) {
                            case RADAR:
                                door.setConnectByType(ModuleType.RADAR, false);
                                break;
                            case SERVO:
                                door.setConnectByType(ModuleType.SERVO, false);
                                break;
                            case SENSOR:
                                door.setConnectByType(ModuleType.SENSOR, false);
                                break;
                        }
                        ...
                        switch (arrayList.get(position).getModuleType()) {
                            case RADAR:
                                door.setConnectByType(ModuleType.RADAR, true);
                                break;
                            case SERVO:
                                door.setConnectByType(ModuleType.SERVO, true);
                                break;
                            case SENSOR:
                                door.setConnectByType(ModuleType.SENSOR, true);
                                break;
                        }
                        Map<String, JSONArray> headers = new HashMap<>();
                        try {
